...
class EditSeed extends Component {
    fileObj = [];
    fileArray = [];
    ...
    setStateValues = () => {
        this.props.selectedMod &&
            this.setState({
                ...
                seed: this.props.selectedMod.seed,
            });
    };
    resetFields = () => {
        this.setState({
    ...
    handleSubmit = (e) => {
        ...
        if (this.checkEmptyField()) {
            ...
            toast("Seed Updated Successfully", {
            ...
            toast("Please give all information and Update Seed", {
                className: "error__message",
            });
        }
    };
...
export default withRouter(
    connect(
        (state) => ({
            ...
            selectedMod: state.allSeeds.selectedMod,
