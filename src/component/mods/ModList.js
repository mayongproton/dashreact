...
class ModList extends Component {
    ...
    deleteMod = (id) => {
        if (window.confirm("Are you sure to delete this Mod?")) {
            this.props.deleteMod(id);

            toast("Mod deleted successfully", {
            ...
            <React.Fragment>
                <div className="mod__list">
                    <table>
                        ...
                        {this.props.allMods && this.props.allMods.length > 0 ? (
                            this.props.allMods.map((mod, index) => (
                                <tr key={index}>
                                    <td>{mod.title}</td>
                            ...
                            <tr>
                                <td colSpan="10">
                                    No Mods Found. Please add some Mods
                                </td>
                            </tr>
                        )}
                    </table>
