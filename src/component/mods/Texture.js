...
import { fetchMod, addMod, deleteMod } from "../../store/actions/textureAction";
...
class Texture extends Component {
    ...
    handleSubmit = (e) => {
        ...
        if (this.checkEmptyField()) {
            this.props.addMod(this.state);
            toast("Texture Added Successfully", {
            ...
            toast("Please give all information and Add Texture", {
                className: "error__message",
            });
        }
    };
    onChangeValue(e) {
        e.preventDefault();
        this.setState({ isupload: e.target.value });
    }
...
export default connect(
    ...
    { fetchCategory, fetchMod, addMod, deleteMod }
)(Texture);
