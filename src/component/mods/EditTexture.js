...
class EditTexture extends Component {
    fileObj = [];
    fileArray = [];
    ...
    handleSubmit = (e) => {
        ...
        if (this.checkEmptyField()) {
            ...
            toast("Texture Updated Successfully", {
            ...
            toast("Please give all information and Update Texture", {
                className: "error__message",
            });
        }
    };
...
export default withRouter(
    connect(
        (state) => ({
            ...
            selectedMod: state.allTextures.selectedMod,
