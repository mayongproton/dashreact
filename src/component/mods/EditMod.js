...
class EditMod extends Component {
    ...
    setStateValues = () => {
        console.log('prp: ', this.props.selectedMod.description)
        this.props.selectedMod &&
            this.setState({
                title: this.props.selectedMod.title,
                categoryid: this.props.selectedMod.categoryid,
                description: RichTextEditor.createValueFromString(this.props.selectedMod.description, 'html'),
    ...
    handleSubmit = (e) => {
        ...
        if (this.checkEmptyField()) {
            ...
            toast("Mod Updated Successfully", {
                ...
                <div className="mod__modal">
                    ...
                    <div className="radio__container">
                        <input
                            ...
                            name="isupload"
                            value="true"
                            checked={this.state.isupload == "true"}
                            onChange={this.handleChange}
                        />{" "}
                        Upload &nbsp; &nbsp; &nbsp; &nbsp;
                        <input
                            ...
                            value="false"
                            name="isupload"
                            checked={this.state.isupload == "false"}
                            onChange={this.handleChange}
                        />{" "}
                        External URL
                    </div>
                        ...
                        <div className="file__container">
                            ...
                            <div className="show__screenshot">
                                ...
                                this.state.uploadfile.length > 0 ? (
                                    <a
                                        download={
                                            this.state.uploadfile[0].filename
                                        }
                                        href={this.state.uploadfile[0].fileSrc}
                                        download
                                    >
                                        {this.state.uploadfile[0].filename}
                                    </a>
...
export default withRouter(
    connect(
        (state) => ({
            ...
            selectedMod: state.allMods.selectedMod,
            allFileImages: state.allMods.allFileImages,
        }),
